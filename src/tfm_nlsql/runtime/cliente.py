...
N_PREDICT = 256  # D-61: 120 truncaba el 11 % de las consultas evaluadas
...
def llama_escucha(timeout: float = 0.3) -> bool:
    """True si /health responde 2xx. No lanza: la UI no debe bloquearse."""
    try:
        with urlopen(Request(_url("/health"), method="GET"), timeout=timeout) as resp:
