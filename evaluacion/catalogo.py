...
Sin 43 (definición ausente). 47 y 48 en LOGISTICA. 50 y 51 en EMBUDO.
53–55 en FUENTES. D-54.
"""
...
LOGISTICA: list[tuple[int, str]] = [
    (47, "¿Qué transportista acumula más entregas con retraso?"),
    (
        48,
        "¿Cuántos pedidos se extraviaron o dañaron y cuánto valor "
        "representan, por trimestre y transportista?",
    ),
]

EMBUDO: list[tuple[int, str]] = [
    (50, "¿Qué categorías acumulan más carritos abandonados?"),
    (
        51,
        "¿Cuál es la tasa de conversión de visita a compra por categoría?",
    ),
]

FUENTES: list[tuple[int, str]] = [
    (
        53,
        "¿Cuánto tarda un vendedor nuevo desde que lo captamos "
        "hasta su primera venta?",
    ),
    (54, "¿Qué canal de captación nos trae los vendedores que más facturan?"),
    (55, "¿Cuánto facturamos el año pasado en euros?"),
]
